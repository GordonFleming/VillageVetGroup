            ...
            <div class="container">
                <div class="row align-items-center justify-content-center mb-5">
                    {#each paginatedItems as product}
                        {#if product.img !== null}
                            <div class="col-lg-3 col-md-3 col-sm-12 align-self-center" out:fade="{{duration: 200}}" in:fade="{{ delay: 200, duration: 400}}">
                                        ...
                                        <div class="text-center">
                                            {#if product.options === false}
                                                <a href="/" class="btn btn-secondary snipcart-add-item mt-4 mb-3"
                                                    ...
                                                    data-item-custom1-name="Weight: {product.singleweight}{product.symbol}">
                                                    Add to bowl
                                                </a>
                                            {:else}
                                                <a href="/" class="btn btn-secondary snipcart-add-item mt-4 mb-3"
