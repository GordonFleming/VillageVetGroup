<div class="container p-5">
    ...
    <ul>
        ...
        <li>Once you have placed your order, it will immediately be sent to us and we will contact you either telephonically or via email to check someone will be home to accept the delivery and then deliver as soon as possible, hopefully the same day or next day.</li>
        <li>On every order there will be a comment or request box, should you have any questions or would like to add any further instructions.</li>
        ...
        <li>If a product show zero stock availability, please email us to find out when we will have your product back in stock. With COVID constraints many of our suppliers are battling with stock and it fluctuates all the time.  </li>
        ...
        <li>Deliveries will take place Monday – Friday between 09h00 and 17h00</li>
        ...
        <li>You may also choose our click-and-collect option and pick up in store. This option is available weekdays, weekends and public holidays - any time during our operating hours.</li>
    </ul>
